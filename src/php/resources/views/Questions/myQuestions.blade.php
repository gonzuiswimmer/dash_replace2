          ...
          <div class="flex flex-wrap -m-12">
            ...
            @else
                ...
                <div class="p-12 md:w-1/2 flex flex-col items-start">
                    ...
                    @endforeach
                <div class="flex items-center flex-wrap border-b-2 border-gray-100 mt-auto w-full">
                ...
                <h2 class="sm:text-3xl text-2xl title-font font-medium text-gray-900"><a href="{{route('questions.show',['question' => $question->id])}}" class="hover:text-blue-500 hover:border-blue-500 hover:border-b-2">{{$question->title}}</a></h2>
