        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-wrap -m-12">
            <div class="w-full">
                <button
                type="button"
                onclick="location.href='{{ route('articles.myblog', Auth::id()) }}' "
            ...
            <div class="p-12 md:w-1/2 items-start">
                ...
                <span class="flex-grow flex flex-col pl-4">
                    ...
                    <span class="text-gray-400 text-xs tracking-widest mt-0.5">{{ $article->updated_at->format('Y-m-d')  }}に保存</span><span>【{{$article->user->department->name}}】</span>
                </span>
                </a>
